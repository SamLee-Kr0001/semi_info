...
st.markdown("""
    ...
    <style>
        ...
        .up-color { color: #DC2626 !important; }   /* 빨강 */
...
STOCK_CATEGORIES = {
    ...
    "🧠 AI ": {"NVIDIA": "NVDA", "Apple": "AAPL", "Alphabet (Google)": "GOOGL / GOOG", "Microsoft": "MSFT", "Meta": "META", "Amazon": "AMZN", "AMD": "AMD", "Tesla": "TSLA", "IBM": "IBM", "Oracle": "ORCL", "Broadcom": "AVGO"},
