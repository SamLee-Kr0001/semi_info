...
DEFAULT_KEYWORDS = {
    # 구버전(Daily Report / P&C 소재 / EDTW 소재 / PKG 소재) 키워드를 4대 축 구조로 병합.
    "Daily Report": [
        "반도체 소재", "반도체 공급망", "EUV", "포토레지스트", "프리커서",
        "반도체 소부장", "중국 반도체", "미국 반도체 규제", "희토류 반도체",
        "일본 반도체", "대만 반도체", "미국 반도체", "중국 대기금", "에치가스",
        "패키징 소재", "Precursor", "Wafer", "소재 공급망", "PFAS 반도체",
        "반도체 소재 공급망", "반도체 세정", "반도체 특수 가스",
    ],
    "기술 동향": [
        "EUV 노광", "차세대 소재", "High-k", "CMP 슬러리", "습식 식각액",
        "박막 증착", "하이브리드 본딩", "GAA 트랜지스터", "deposition", "Precursor",
        "Low-k", "Inhibitor", "ASD", "ALE", "Catalyst", "wet etchant",
        "CMP Slurry", "cowos", "hybrid bonding",
    ],
    "기업 변화": [
        "반도체 소재 투자", "반도체 증설", "반도체 M&A", "소재 기업 실적",
        "파운드리 증설", "반도체 소재 공장", "중국 대기금",
    ],
    "SCM·공급망": [
